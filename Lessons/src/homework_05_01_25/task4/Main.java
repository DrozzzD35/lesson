package homework_05_01_25.task4;
...
public class Main {
    ...
    private static Float getMinKcalsSum(String firstDishKcal, String secondDishKcal, String firstDesert, String secondDesert) {
        float minDishKcal = Float.parseFloat(secondDishKcal) + Float.parseFloat(firstDishKcal); // вычислите минимальную калорийность основного блюда
