package homeWork_24_12_24.Work8;

import java.util.Scanner;
/*
Осталось исправить код в классе Work8 — конструктор
 по-умолчанию больше не генерируется и возникает ошибка.
При вызове конструктора с параметрами передайте следующие
 значения аргуметов: 78.5 для доллара, 88.7 для евро и 0.75 для японской иены.
*
* */
public class Work8 {
